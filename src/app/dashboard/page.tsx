        ...
        <div className="w-full sm:w-[280px] bg-[#97f1e5] lg:mt-10 p-5 rounded-md flex flex-grow">
          <div className="w-full">
            ...
            <p>
              ...
              save photos, all seamlessly stored in your local browser for easy
              undo actions. Engage with our photos like and save with a click,
              effortlessly managed in your local storage.
            </p>
            <DashboardButton
              text="All Photos"
              color="bg-[#13AC95]"
